        ...
        return {
            ...
            activate: function () {
                router.map([
                    ...
                    { route: 'banners', title: 'Banners', moduleId: 'viewmodels/banners', nav: true, hash: '#banners', icon: "fa fa-external-link-square" },
                    { route: 'banner(/:id)', title: 'Banner', moduleId: 'viewmodels/banner', nav: false, hash: '#banner' },
                    { route: 'banner/:id/images', title: 'Imagen', moduleId: 'viewmodels/bannerImages', nav: false },
