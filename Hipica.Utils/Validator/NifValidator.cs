...
namespace Hipica.Utils.Validator
{
    ...
    {
        private Hipica.Utils.Validator.NifAttribute.Type[] AllowedTypes { get; set; }
        ...
        protected override bool IsValid2(string value, IConstraintValidatorContext context)
        {
            ...
            {
                foreach (Hipica.Utils.Validator.NifAttribute.Type type in this.AllowedTypes)
                {
                    switch (type)
                    {
                        case Hipica.Utils.Validator.NifAttribute.Type.NIF:
                            isValid = ValidationUtils.IsValidNIF(value);
                            break;

                        case Hipica.Utils.Validator.NifAttribute.Type.CIF:
                        ...
                        case Hipica.Utils.Validator.NifAttribute.Type.NIE:
